...
func main() {
	...
	corpus := service.NewCorpusCache()
	tfidf := service.NewTfidfService(cfg.MaxKeywordCount, corpus)
	...
	articleSvc := service.NewArticleService(memStore, memStore, analyzer, ids, cfg.MaxArticleLength, corpus, preprocessor)
	taskSvc := service.NewTaskService(memStore, memStore, memStore, analyzer, ids, queue, cfg.MaxArticleLength, corpus, preprocessor)
